...
var StandardController = class _StandardController {
  ...
  async initialize(request) {
    ...
    !this.config.system.navigatePopups && await this.preGeneratePkceCodes(initCorrelationId);
    this.initialized = true;
    this.eventHandler.emitEvent(EventType.INITIALIZE_END);
    initMeasurement.end({
      allowPlatformBroker,
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-TNFJ4HA6.js");
    }
  } catch (e) {
  }
  return void 0;
...
*/
//# sourceMappingURL=chunk-L2BX3HI7.js.map
