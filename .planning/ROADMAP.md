...
- [x] 10-02-PLAN.md — Backend API integration tests and unit tests
- [x] 10-03-PLAN.md — Frontend component tests with MSW
- [x] 10-04-PLAN.md — E2E tests with Playwright
