...
- Unified status system uses status.isReadOnly instead of separate isStopped boolean (quick-012)
...
- Import folder structure: staging/ (CSVs), mappings/ (YAML configs), scripts/ (import logic) (08-01)
- Staging CSVs gitignored to prevent committing generated files (08-01)
- Import tracking via nullable importedAt timestamp and importSource filename on projects table (08-01)
- Date parser handles Excel serial dates, quarters (Q1-Q4), years, year-month, and ISO formats (08-01)
